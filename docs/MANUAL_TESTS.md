...
| Q.29 | Accept a `$20` ride, enter `$25` final earnings, then mark another `$20` offer Cancelled and enter a `$5` fee | History/session/goal totals use `$25 + $5`; the original cancelled `$20`, its distance, minutes and rates do not count; removing either correction refreshes every total | [ ] build 111 |
