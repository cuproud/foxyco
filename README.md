...
- **Status:** `1.0.10+67` release bundle built; tour fixes and stacked cross-app offers need live-device verification
...
| [`docs/HANDOFF_2026-08-21_TOUR_FIXES.md`](docs/HANDOFF_2026-08-21_TOUR_FIXES.md) | Build 67 tour fixes, release artifact, verification and device-test focus |
